...
import { services } from "@/content/site.en";
    ...
    <section id="services" className="py-24 md:py-32">
      <Container>
        <Reveal>
          ...
          <h2 className="mt-3 max-w-xl text-3xl font-extrabold leading-tight tracking-tight text-fg sm:text-4xl">{services.h2}</h2>
        </Reveal>
