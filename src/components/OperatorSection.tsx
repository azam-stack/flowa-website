        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1fr_1fr] lg:gap-12">
          ...
          <Reveal variant="surface" threshold={0.2} className="relative -mb-[var(--band-pad,4rem)] h-[420px] sm:h-[480px] lg:h-[560px]">
            <div className="operator absolute inset-0">
              ...
              <div className="absolute bottom-[10%] right-[2%] max-w-[50%] rounded-card border border-white/15 bg-ink/90 p-3 text-white shadow-float backdrop-blur-md">
              ...
              <span className="absolute bottom-[8%] left-[8%] rounded-full border border-white/20 bg-ink/90 px-2.5 py-1 text-[11px] font-medium text-white backdrop-blur-md">ICP 94%</span>
              <span className="absolute bottom-[2%] left-1/2 -translate-x-1/2 rounded-full bg-ink/80 px-2 py-0.5 text-[11px] text-white/70">{demo.label}</span>
            </div>
          </Reveal>
        </div>
      </Container>
